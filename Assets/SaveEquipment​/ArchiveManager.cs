...
public class ArchiveManager : MonoBehaviour
{
    ...
    [Header("????浵")]
    public DeleteArchiveConfirm deleteArchiveConfirm;  // ????浵??????
    ...
    public void ShowEquipmentInfo(EquipmentType type, int id, EquipmentIcon icon)
    {
        ...
        else
        {
            ...
            // 未解锁且是通关装备 0~14，显示积分解锁按钮
            bool canUnlockByPoints = type == EquipmentType.ClearEquipment && id >= 0 && id <= 14;
            if (unlockByPointsButton != null)
            {
